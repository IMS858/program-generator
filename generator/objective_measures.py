...
DYNAMO_TESTS = {
    ...
    "trunk_flexion": ("lumbar", "flexion"),
    "trunk_extension": ("lumbar", "extension"),
}
...
class ForceMeasure:
    ...
    # Provenance · "manual" when a coach typed it, "vald_api" when it came off
    # the wire. Printed on the coach page · a number nobody typed should be
    # visibly distinguishable from one somebody did.
    source: str = "manual"
    source_id: Optional[str] = None      # VALD testId, when applicable
    # Extra metrics VALD computes for free on the same payload · RFD in
    # particular is more sensitive to detraining than peak force is.
