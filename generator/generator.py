...
class Generator:
    ...
    def _build_strength_b(self, day_type: str, priorities: list[FRAPriority],
        ...
        if day_type == "strength_lb":
            ...
            # Dedup safeguard · if this name is already in the block, swap
            existing_names = {e.name for e in exercises}
            if bridge_name in existing_names:
                # Walk the bridge_candidates and pick the first not-yet-used
