            ...
            if not isinstance(rows, list):
                ...
                for i, row in enumerate(rows):
                    ...
                    if deg is None:
                        ...
                        # Negative degrees are legitimate · an extension
                        # deficit reads negative, and VALD's own documented
                        # example is -32°. The first cut of this rule stopped
                        # at -30 and would have rejected real data.
                        errors.append(f"{at} degrees {deg} is out of range (-50–200)")
